                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Method')">
                                    @if(request()->routeIs('admin.users.deposits') || request()->routeIs('admin.users.deposits.method'))
                                   <a href="{{ route('admin.users.deposits.method',[$deposit->gateway->alias,@$type?$type:'all',$userId]) }}">{{ $deposit->gateway->name }}</a>
                                   @else
                                   <a href="{{ route('admin.deposit.method',[$deposit->gateway->alias,@$type?$type:'all']) }}">{{ $deposit->gateway->name }}</a>
                                   @endif
