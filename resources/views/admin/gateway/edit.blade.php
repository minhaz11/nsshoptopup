                                                    ...
                                                    <div class="card-body">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   value="{{ getNumber($gateway_currency->min_amount) }}"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0"
                                                                   ...
                                                                   value="{{ getNumber($gateway_currency->max_amount) }}"
                                                                   required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0"
                                                                   ...
                                                                   value="{{ getNumber($gateway_currency->fixed_charge) }}"
                                                                   required/>
                                                        </div>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0"
                                                                   ...
                                                                   value="{{ getNumber($gateway_currency->percent_charge) }}"
                                                                   required/>
                                                        </div>
                                                    </div>
                                                </div>
